...
import (
	...
	mockdb "github.com/agomesd/simplebank/db/mock"
	...
	testCases := []struct {
	...
	}{
		{
			...
			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
				...
				requireBodyMatchesUser(t, recorder.Body, user)
			},
		},
	}
...
func requireBodyMatchesUser(t *testing.T, body *bytes.Buffer, user db.User) {
